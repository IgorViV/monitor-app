...
export const REGION_CAPITALS = {
    ...
    'Томская область': { x: 2087, y: 1647, name: 'Томск', float: 'bottom' },
    ...
    'Хабаровский край': { x: 3958, y: 1804, name: 'Хабаровск', float: 'bottom' },
    ...
    'Республика Крым': { x: 109, y: 1150, name: 'Симферополь', float: 'bottom' },
    ...
    'Республика Северная Осетия-Алания': { x: 323, y: 1530, name: 'Владикавказ', float: 'left' },
    'Республика Ингушетия': { x: 371, y: 1555, name: 'Магас', float: 'left' },
    'Чеченская Республика': { x: 371, y: 1555, name: 'Грозный', float: 'right' },
    'Карачаево-Черкесская Республика': { x: 299, y: 1403, name: 'Черкесск', float: 'left' },
    ...
    'Херсонская область': { x: 169, y: 1070, name: 'Херсон', float: 'top' },
    'Запорожская область': { x: 246, y: 1123, name: 'Мелитополь', float: 'bottom' },
