...
function getRegionPrepositional(regionName) {
    const prepositionalMap = {
        ...
        'Чукотский автономный округ': 'Чукотском АО',
        'Чукотский АО': 'Чукотском АО',
        'Ненецкий автономный округ': 'Ненецком АО',
        'Ненецкий АО': 'Ненецком АО',
        'Ямало-Ненецкий автономный округ': 'Ямало-Ненецком АО',
        'Ямало-Ненецкий АО': 'Ямало-Ненецком АО',
        'Ханты-Мансийский автономный округ - Югра': 'Ханты-Мансийском АО',
        'Ханты-Мансийский автономный округ': 'Ханты-Мансийском АО',
        'Ханты-Мансийский АО': 'Ханты-Мансийском АО',
    };
